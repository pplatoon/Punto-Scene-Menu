...
static void drawEntry(menuEntry_s* me, int n, int is_active) {
    ...
    if (is_active) {
        ...
        snprintf(tmpstr, sizeof(tmpstr)-1, "Nombre: %s\nAutor: %s\nVersion: %s", me->name, me->author, me->version);
...
void menuLoop() {
    ...
    DrawText(tahoma24, 64, 64, MakeColor(64, 64, 64, 255), "Punto Scene Menu");
    DrawText(tahoma12, 64 + 256 + 128 + 128, 64 + 16, MakeColor(64, 64, 64, 255), "v0.1");
